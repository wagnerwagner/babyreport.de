                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <div style="font-family:Helvetica Neue;font-size:18px;line-height:24px;text-align:left;color:#000000;"> Hallo
                        <?= $orderPage->givenName() ?>
                        <?= $orderPage->familyName() ?>,<br>
                        <br> vielen Dank für Deine Bestellung auf <a href="<?= $site->url() ?>" class="link" style="color: black;">babyreport.de</a>. Falls Du Fragen haben solltest, kannst Du uns hier erreichen: <a href="mailto:info@babyreport.de" class="link" style="color: black;">info@babyreport.de</a>
                      </div>
                    </td>
                  </tr>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:50px;word-break:break-word;">
                      <div style="font-family:Helvetica Neue;font-size:23px;font-weight:bold;line-height:1;text-align:left;color:#000000;"> Zahlungsaufforderung </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:20px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="cellspacing:0;color:#000000;font-family:Helvetica Neue;font-size:18px;line-height:24px;table-layout:auto;width:100%;">
                        <tr>
                          <th class="th" style="text-align: left; text-transform: uppercase; font-size: 14px; font-weight: 400; padding-right: 16px; padding-top: 3px;" align="left">Empfänger</th>
                          <td>
                            <?= $site->accountHolder() ?>
                          </td>
                        </tr>
                        <tr>
                          <th class="th" style="text-align: left; text-transform: uppercase; font-size: 14px; font-weight: 400; padding-right: 16px; padding-top: 3px;" align="left">IBAN</th>
                          <td>
                            <?= Merx::formatIBAN((string)$site->iban()) ?>
                          </td>
                        </tr>
                        <tr>
                          <th class="th" style="text-align: left; text-transform: uppercase; font-size: 14px; font-weight: 400; padding-right: 16px; padding-top: 3px;" align="left">Betrag</th>
                          <td>
                            <?= Merx::formatPrice($orderPage->cart()->getSum()) ?>
                          </td>
                        </tr>
                        <tr>
                          <th class="th" style="text-align: left; text-transform: uppercase; font-size: 14px; font-weight: 400; padding-right: 16px; padding-top: 3px;" align="left">Verwendungszweck</th>
                          <td>Baby Report
